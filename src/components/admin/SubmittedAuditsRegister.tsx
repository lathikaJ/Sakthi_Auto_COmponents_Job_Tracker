          ...
          <table className="w-full border-collapse text-left text-xs font-sans">
            <thead>
              <tr className="border-b border-slate-300 bg-slate-200 font-mono text-[11px] uppercase text-slate-900 font-black">
                ...
                <th className="p-3 min-w-[140px] font-black text-slate-900 text-right">ACTION</th>
            ...
            <tbody className="divide-y divide-slate-200 text-slate-900">
              ...
              {filtered.length === 0 && (
                <tr>
                  <td colSpan={isAdmin ? 10 : 9} className="p-8 text-center text-xs font-medium text-slate-500">
