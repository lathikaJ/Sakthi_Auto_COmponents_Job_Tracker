...
const EMPLOYEE_LIST = ["688079", "663875", "710250", "666468", "665773", "665965", "708818", "667685"];
...
export function ExcelTaskGrid({
  ...
  const handleDeleteSelected = () => {
    ...
    toDelete.forEach((r) => {
      if (r.id) {
        addDeletedAuditIdentifier(r.id);
        void supabase.from("audit_assignments").delete().eq("id", r.id);
      }
    });
